...
def inspect_legacy_database(db_path, source_root='/vault/E/shared-sets'):
...
class DatabaseOptimizer:
    ...
    def __init__(self, db_path, source_root='/vault/E/shared-sets', progress=print):
