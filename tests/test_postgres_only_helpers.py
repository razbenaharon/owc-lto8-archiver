...
class PostgresOnlyHelperTests(unittest.TestCase):
    ...
    def test_record_key_includes_source_host(self):
        left = _file_record_key("/data/a.bin", "TAPE001", source_host="srv02")
    ...
    def test_remote_catalog_chain_uses_short_source_host_root(self):
        chain = catalog_directory_chain("/srv/project/file.dat", "srv02.example")
        self.assertEqual(
            chain,
            [
                ("srv02", None, "srv02"),
                ("srv02/srv", "srv02", "srv"),
                ("srv02/srv/project", "srv02/srv", "project"),
            ],
        )
